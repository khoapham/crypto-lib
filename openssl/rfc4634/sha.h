...
extern int SHA1Export(SHA1Context *context,
...
extern int SHA224Export(SHA224Context *context,
...
extern int SHA256Export(SHA256Context *context,
...
extern int SHA384Export(SHA384Context *, uint8_t Message_Digest[SHA384HashSize]);
...
extern int SHA512Export(SHA512Context *, uint8_t Message_Digest[SHA512HashSize]);

/* Unified SHA functions, chosen by whichSha */
extern int USHAReset(USHAContext *, SHAversion whichSha);
extern int USHAInput(USHAContext *, const uint8_t *bytes,
		unsigned int bytecount);
extern int USHAFinalBits(USHAContext *, const uint8_t bits,
		unsigned int bitcount);
extern int USHAResult(USHAContext *, uint8_t Message_Digest[USHAMaxHashSize]);
extern int USHAExport(USHAContext *ctx, uint8_t Message_Digest[USHAMaxHashSize]);
